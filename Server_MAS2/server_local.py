...
def update_info():
    ...
    for boid in flock:
        ...
        info['positions'].append(pos)
        info['colors'].append(boid.color)
        info['kinds'].append(boid.kind)
    print(info)
    return info


def info_to_json(boidData):
    kinds = boidData['kinds']
    colors = boidData['colors']
    positions = boidData['positions']
