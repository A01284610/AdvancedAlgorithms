...
int main()
{
	...
	pair<int,int> a = make_pair(2,3);
	pair<int,int> b = make_pair(2,2);
	pair<int,int> c = make_pair(1,2);
	pair<int,int> d = make_pair(1,9);
	pair<int,int> e = make_pair(1,4);
	pair<int,int> f = make_pair(2,0);
	pair<int,int> g = make_pair(1,0);
	pair<int,int> h = make_pair(2,-1);


	vector<pair<int,int>> aa = {a,b,c,d,e,f,g,h};
