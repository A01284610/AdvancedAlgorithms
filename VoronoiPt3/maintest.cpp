...
int main() {
  ...
  vb.insert_point(656,607);
  vb.insert_point(349,228);
  vb.insert_point(460,380);
  vb.insert_point(657,378);
  vb.insert_point(618,187);
  vb.insert_point(155,99);
  vb.insert_point(541,570);
  vb.insert_point(272,649);
  vb.insert_point(429,98);
  vb.insert_point(120,339);
